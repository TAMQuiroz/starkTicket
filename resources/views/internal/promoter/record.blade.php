            ...
            <div class="modal fade" id="cancelEvent{{$event->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-info" data-dismiss="modal" data-toggle="modal" data-target="#cancelModal{{$event->id}}" >Guardar</button>

                        <!-- MODAL in modal Cancel-->
<!--                         <div class="modal fade"  id="cancelModal{{$event->id}}">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">¿Estás seguro que deseas cancelar estas funciones?</h4>
                              </div>
                              <div class="modal-body">
