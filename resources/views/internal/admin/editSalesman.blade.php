...
@section('content')
        ...
        <div class="row">
          <div class="col-sm-8">
             {!!Form::open(array('url' => 'admin/salesman/'.$user->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
             {!!Form::hidden('id', $user->id)!!}
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="{{url('admin/salesman')}}"><button type="button" class="btn btn-info">Cancelar</button></a>
                </div>
              </div>
